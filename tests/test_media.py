...
def test_upload(session, client, mocker, login):
    ...
    expected = {
        "filename": expected_original_filename,
    ...
    for file in expected_path.iterdir():
        ...
        # we can verify correct name matches our mock - returned by
        # `random_short_string` - and ensure we have the correct suffix
        assert file.name == "abcdef.jpg"
    ...
    assert media.original_filename == expected_original_filename
